...
dtLib = mkDtLib [(Deposit, mkGenOp deposit, $(check Deposit depositCtrt)),
                 (Withdraw, mkGenOp withdraw, $(check Withdraw withdrawCtrt)),
                 (GetBalance, mkGenOp getBalance, $(check GetBalance getBalanceCtrt))]
